...
export default class HeadBar extends Component {
	...
	render() {
		return (
			<Header style={{
				backgroundColor: this.props.headBackgroundColor ? this.props.headBackgroundColor : colors.appColor,
				borderBottomColor: '#f0f0f0'
			}}>
				<Left style={{flex:1}}>
					{/*左侧默认显示返回键*/}
					{(this.props.leftVisible !== false && !this.props.leftChildren) && (
						<TouchableOpacity style={{paddingLeft: 10, paddingRight: 25, paddingTop: 15, paddingBottom: 5}}
					...
					{/*左侧菜单栏扩展*/}
					{(this.props.leftVisible !== false && this.props.leftChildren && (
						<TouchableOpacity style={{paddingLeft: 10, paddingRight: 20, paddingTop: 15, paddingBottom: 15}}
															onPress={this.props.leftBackIconOnPress}>
							<Text style={{fontSize: 14, color: colors.textBlack, width: 60}}>取消</Text>
						</TouchableOpacity>
					))}
				</Left>
				...
				<Right style={{flex:1}}>
					...
					{this.props.rightVisible && !this.props.rightChildren && (
						<View style={{flexDirection: 'row', display: 'flex'}}>
							<TouchableOpacity style={{paddingRight: 5, paddingLeft: 15, paddingTop: 15, paddingBottom: 15}}
								...
								<View style={{alignItems: 'center'}}>
									...
									{this.props.rightOnlyLocalImageVisible && (
										<Image style={{
											width: this.props.rightLocalImageWidth ? this.props.rightLocalImageWidth : 20,
									...
									{this.props.rightOnlyRemoteImageVisible && (
										<Image style={{
											width: this.props.rightRemoteImageWidth ? this.props.rightRemoteImageWidth : 20,
									...
									{this.props.rightOnlyTextVisible && (
										<Text style={{
											...
											color: this.props.rightTextFontColor ? this.props.rightTextFontColor : colors.textTitle
