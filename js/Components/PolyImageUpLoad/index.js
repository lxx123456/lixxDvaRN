...
import {hidePicker} from "js/Utils/PickerUtils";
...
export default class PolyUpload extends React.Component {
	...
	static propTypes = {
		max: PropTypes.number,//可选的最大数量
		navigation: PropTypes.any,//navigation
		defaultFileList: PropTypes.array,//初始化显示的图片[id,name,uri]
...
// }
	...
	render() {
		let imageSource = require('js/Assets/upLoadFile.png');
		return (
							...
							<View
								...
								<TouchableOpacity
									...
									<Image
										...
										source={require('js/Assets/delete.png')}/>
								</TouchableOpacity>
